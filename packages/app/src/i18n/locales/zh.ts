...
export default {
  ...
  "dashboard.error": "错误",
  "dashboard.load_tasks_failed": "加载任务失败",
  "dashboard.loading_tasks": "正在加载任务...",
  "dashboard.no_tasks_yet": "还没有任务。",
  "dashboard.show_more": "查看更多",
  "dashboard.show_more_count": "再显示 {count} 个",
  "dashboard.workspace_options": "工作区选项",
  "dashboard.edit_workspace_name": "编辑名称",
  "dashboard.share_workspace": "分享...",
  "dashboard.test_connection": "测试连接",
  "dashboard.edit_connection": "编辑连接",
  "dashboard.stop_sandbox": "停止沙盒",
  "dashboard.remove_workspace": "移除工作区",
  "dashboard.add_workspace": "添加工作区",
  "dashboard.add_workspace_new": "新建工作区",
  "dashboard.add_workspace_remote": "连接远程",
  "dashboard.add_workspace_import": "导入配置",
  "dashboard.sidebar_workspaces": "工作区",
  "dashboard.sidebar_files": "资源",
  "dashboard.file_explorer_desktop_only": "文件浏览器仅在桌面应用中可用。",
  "dashboard.file_explorer_remote_unavailable": "远程工作区不支持文件浏览器。",
  "dashboard.file_explorer_select_workspace": "请选择一个工作区以浏览文件。",
  ...
  "dashboard.git_repo_label": "Git 仓库地址（可选）",
  "dashboard.git_repo_placeholder": "https://github.com/org/repo.git",
  "dashboard.git_repo_hint": "填写后将克隆到应用数据目录的工作区缓存中。",
  ...
  "task_center.stage.idle": "待处理",
  "task_center.stage.syncing": "同步中",
  "task_center.stage.analyzing": "分析",
  "task_center.stage.designing": "设计",
  "task_center.stage.planning": "计划",
  "task_center.stage.implementing": "实现",
  "task_center.stage.reviewing": "评审",
  "task_center.stage.archiving": "归档",
  "task_center.substage.workspace_prep": "环境初始化",
  "task_center.substage.plan_exec": "执行计划",
  "task_center.substage.tests": "运行测试",
  "task_center.substage.fixes": "修复问题",
  "task_center.substage.ready_review": "待评审",
  "task_center.task_status.pending": "待执行",
  "task_center.task_status.in_progress": "执行中",
  "task_center.task_status.completed": "已完成",
  "task_center.task_status.failed": "失败",
  "task_center.status.todo": "待处理",
  "task_center.status.progress": "进行中",
  "task_center.status.done": "已完成",
  "task_center.status.failed": "阻塞",
  "task_center.status.archived": "已归档",
  "task_center.last_sync_never": "尚未同步",
  "task_center.execution_title": "执行计划",
  "task_center.task_line": "任务 {index}: {title}",
  "task_center.execute": "开始执行",
  "task_center.mark_complete": "标记完成",
  "task_center.executing": "执行中...",
  "task_center.no_description": "暂无描述",
  "task_center.progress_label": "进度: {done} / {total}",
  "task_center.all_tasks_completed": "✓ 所有任务已完成",
  "task_center.sync_hint": "同步你的 TFS 工作项，并通过 OpenWork 自动化推进。",
  "task_center.syncing": "同步中",
  "task_center.refresh": "刷新",
  "task_center.last_sync": "上次同步: {time}",
  ...
  "workspace.badge.sandbox": "沙盒",
  "workspace.badge.remote": "远程",
  "workspace.badge.repo": "仓库",
  "workspace.status.needs_attention": "需要关注",
  "workspace.status.switch": "切换",
  "workspace.status.active": "已激活",
  "workspace.action.expand": "展开",
  "workspace.action.collapse": "收起",
  ...
  "session.touched_files_title": "触达文件",
  "session.touched_files_empty": "还没有。",
  "session.touched_files_open": "打开 {path}",
  "session.touched_files_show_fewer": "收起",
  "session.touched_files_show_more": "显示更多 {count} 个",
  "markdown_editor.default_title": "Markdown",
  "markdown_editor.readonly_formatting_hint": "只读预览。可编辑的文件类型包括 Markdown、JSON、YAML、TOML、JavaScript 和 TypeScript。",
  "markdown_editor.readonly_connect_hint": "只读预览。连接 OpenWork 服务器工作区以编辑。",
  "markdown_editor.readonly_preview": "只读预览。",
  "markdown_editor.preview_requires_desktop_or_server": "文件预览需要桌面应用或 OpenWork 服务器工作区。",
  "markdown_editor.load_failed": "加载文件失败",
  "markdown_editor.toast_readonly": "只读预览",
  "markdown_editor.toast_formatting_only_scripts": "格式化仅支持 JavaScript 和 TypeScript 文件。",
  "markdown_editor.toast_already_formatted": "已格式化。",
  "markdown_editor.toast_basic_formatting": "已应用基础格式化（仅空白）。",
  "markdown_editor.badge_unsaved": "未保存",
  "markdown_editor.badge_readonly": "只读",
  "markdown_editor.view_write": "编辑",
  "markdown_editor.view_preview": "预览",
  "markdown_editor.reload_title": "从磁盘重新加载",
  "markdown_editor.reload": "重新加载",
  "markdown_editor.format_title": "基础空白格式化",
  "markdown_editor.format": "格式化",
  "markdown_editor.save_title": "保存 (Ctrl/Cmd+S)",
  "markdown_editor.save": "保存",
  "markdown_editor.saving": "保存中...",
  "markdown_editor.overwrite_confirm": "文件已被修改，仍要覆盖吗？",
  "markdown_editor.cancel": "取消",
  "markdown_editor.overwrite": "覆盖",
  "markdown_editor.discard_reload_confirm": "放弃未保存的更改并从磁盘重新加载？",
  "markdown_editor.discard_close_confirm": "放弃未保存的更改并关闭？",
  "markdown_editor.keep": "保留",
  "markdown_editor.discard": "丢弃",
  "markdown_editor.switch_to": "切换到 {path}",
  "markdown_editor.discard_switch": "丢弃并切换",
  "markdown_editor.save_switch": "保存并切换",
  "markdown_editor.empty_preview": "暂无可预览内容。请在编辑模式输入 Markdown。",
  "share_workspace.title": "分享工作区",
  "share_workspace.close": "关闭",
  "share_workspace.access_title": "访问权限",
  "share_workspace.access_hint": "仅与可信的人分享。拥有这些信息的人都可连接。",
  "share_workspace.hide": "隐藏",
  "share_workspace.show": "显示",
  "share_workspace.copied": "已复制",
  "share_workspace.copy": "复制",
  "share_workspace.config_title": "配置包",
  "share_workspace.config_hint": "导出 `.opencode/` 与 `opencode.json` 以便复用。",
  "share_workspace.export_desktop_only": "仅在桌面应用的本地工作区可导出。",
  "share_workspace.export": "导出",
  "share_workspace.bots_title": "机器人",
  "share_workspace.bots_hint": "Alpha。请在设置中配置消息通道。",
  "share_workspace.alpha": "alpha",
  "share_workspace.open_bots_settings": "打开机器人设置",
  "plugins.title": "OpenCode 插件",
  "plugins.subtitle": "管理项目或全局的 `opencode.json` 插件配置。",
  "plugins.scope.project": "项目",
  "plugins.scope.global": "全局",
  "plugins.refresh": "刷新",
  "plugins.config_label": "配置",
  "plugins.config_not_loaded": "尚未加载",
  "plugins.suggested_title": "推荐插件",
  "plugins.setup_show": "设置",
  "plugins.setup_hide": "隐藏设置",
  "plugins.added": "已添加",
  "plugins.add": "添加",
  "plugins.step_open": "打开",
  "plugins.step_path": "路径",
  "plugins.empty": "尚未配置插件。",
  "plugins.enabled": "已启用",
  "plugins.add_label": "添加插件",
  "plugins.add_placeholder": "opencode-wakatime",
  "plugins.add_hint": "添加 npm 包名，例如 opencode-wakatime",
  "config.status.connected": "已连接",
  "config.status.limited": "受限",
  "config.status.disconnected": "未连接",
  "config.reload.connect_required": "连接此工作区后才能重新加载。",
  "config.reload.local_only": "仅本地工作区或已连接的 OpenWork 服务器支持重新加载。",
  "config.reload.loading": "重新加载中...",
  "config.reload.action": "重启引擎",
  "config.workspace.title": "工作区配置",
  "config.workspace.description": "这些设置仅影响当前工作区（分享、重载、机器人）。全局行为在设置中配置。",
  "config.workspace.label": "工作区: {id}",
  "config.reload.title": "引擎重载",
  "config.reload.subtitle": "重启此工作区的 OpenCode 服务。",
  "config.reload.now": "立即重载",
  "config.reload.now_hint": "应用配置更新并重新连接你的会话。",
  "config.reload.active_runs_warning": "重载会停止正在运行的任务。",
  "config.auto_reload.title": "自动重载（本地）",
  "config.auto_reload.subtitle": "在空闲时，自动应用代理/技能/命令/配置变更。",
  "config.auto_reload.desktop_only": "仅桌面应用的本地工作区可用。",
  "config.toggle.on": "开",
  "config.toggle.off": "关",
  "config.auto_reload_resume.title": "自动重载后恢复会话",
  "config.auto_reload_resume.subtitle": "如果任务执行中触发重载，将在完成后发送恢复消息。",
  "config.auto_reload_resume.disabled_hint": "请先开启自动重载",
  "config.diagnostics.title": "诊断包",
  "config.diagnostics.subtitle": "复制脱敏的运行状态用于调试。",
  "config.copy.copied": "已复制",
  "config.copy.copy": "复制",
  "config.sharing.title": "OpenWork 服务器分享",
  "config.sharing.subtitle": "与可信设备分享这些信息。保持同一网络以获得最快连接。",
  "config.host.offline": "离线",
  "config.host.available": "可用",
  "config.sharing.server_url": "OpenWork 服务器地址",
  "config.sharing.starting_server": "正在启动服务器…",
  "config.sharing.mdns_hint": ".local 名称更易记，但可能在部分网络不可用。",
  "config.sharing.lan_hint": "同一 Wi-Fi 下使用本地 IP 连接最快。",
  "config.sharing.access_token": "访问令牌",
  "config.sharing.access_token_hint": "用于连接此服务器的手机或笔记本。",
  "config.sharing.server_token": "服务器令牌",
  "config.sharing.server_token_hint": "请妥善保管。审批操作需要此令牌。",
  "config.token.show": "显示",
  "config.token.hide": "隐藏",
  "config.token.masked": "••••••••••••",
  "config.token.missing": "—",
  "config.sharing.share_hint": "如需分享单个工作区链接，请在工作区菜单中使用 {share}。",
  "config.share_action": "分享...",
  "config.server.title": "OpenWork 服务器",
  "config.server.subtitle": "连接 OpenWork 服务器。使用管理员提供的地址和令牌。",
  "config.server.url_label": "OpenWork 服务器地址",
  "config.server.url_placeholder": "http://127.0.0.1:8787",
  "config.server.url_hint": "使用 OpenWork 服务器提供的地址。",
  "config.server.token_label": "访问令牌",
  "config.server.token_placeholder": "粘贴你的令牌",
  "config.server.token_hint": "可选。粘贴访问令牌进行验证。",
  "config.server.resolved_url": "解析后的工作区地址: {url}",
  "config.server.not_set": "未设置",
  "config.server.workspace_id": "工作区 ID: {id}",
  "config.server.unavailable": "不可用",
  "config.server.test_success": "连接成功。",
  "config.server.test_failed_hint": "连接失败，请检查地址和令牌。",
  "config.server.test_failed": "连接失败。",
  "config.server.testing": "测试中...",
  "config.server.test": "测试连接",
  "config.save": "保存",
  "config.reset": "重置",
  "config.server.testing_status": "正在测试连接...",
  "config.server.status_updated": "连接状态已更新。",
  "config.server.sync_required": "需要连接 OpenWork 服务器以同步技能、插件和命令。",
  "config.messaging.title": "消息身份",
  "config.messaging.subtitle": "在 {identities} 标签页管理 Telegram/Slack/WeCom 身份与路由。",
  "config.messaging.identities_tab": "身份",
  "config.desktop_only_note": "部分配置功能（本地分享 + 消息桥接）需要桌面应用。",
  ...
  "settings.general_tab": "通用",
  "settings.debug_tab": "调试",
  ...
  "app.error.choose_folder_or_repo": "请选择一个文件夹或填写 Git 仓库地址。",
