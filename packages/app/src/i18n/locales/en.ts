...
export default {
  ...
  "dashboard.load_tasks_failed": "Failed to load tasks",
  ...
  "dashboard.workspace_options": "Workspace options",
  "dashboard.edit_workspace_name": "Edit name",
  "dashboard.share_workspace": "Share...",
  "dashboard.test_connection": "Test connection",
  "dashboard.edit_connection": "Edit connection",
  "dashboard.stop_sandbox": "Stop sandbox",
  "dashboard.remove_workspace": "Remove workspace",
  "dashboard.add_workspace": "Add a workspace",
  "dashboard.add_workspace_new": "New workspace",
  "dashboard.add_workspace_remote": "Connect remote",
  "dashboard.add_workspace_import": "Import config",
  "dashboard.sidebar_workspaces": "Workspaces",
  "dashboard.sidebar_files": "Files",
  "dashboard.file_explorer_desktop_only": "File explorer is available in the desktop app.",
  "dashboard.file_explorer_remote_unavailable": "File explorer is unavailable for remote workspaces.",
  "dashboard.file_explorer_select_workspace": "Select a workspace to browse files.",
  ...
  "dashboard.git_repo_label": "Git repository URL (optional)",
  "dashboard.git_repo_placeholder": "https://github.com/org/repo.git",
  "dashboard.git_repo_hint": "If set, OpenWork clones it into your app data workspace cache.",
  ...
  "task_center.stage.idle": "Idle",
  "task_center.stage.syncing": "Syncing",
  "task_center.stage.analyzing": "Analyzing",
  "task_center.stage.designing": "Designing",
  "task_center.stage.planning": "Planning",
  "task_center.stage.implementing": "Implementing",
  "task_center.stage.reviewing": "Reviewing",
  "task_center.stage.archiving": "Archiving",
  "task_center.substage.workspace_prep": "Workspace prep",
  "task_center.substage.plan_exec": "Execute plan",
  "task_center.substage.tests": "Run tests",
  "task_center.substage.fixes": "Fixes",
  "task_center.substage.ready_review": "Ready for review",
  "task_center.task_status.pending": "Pending",
  "task_center.task_status.in_progress": "In progress",
  "task_center.task_status.completed": "Completed",
  "task_center.task_status.failed": "Failed",
  "task_center.status.todo": "To do",
  "task_center.status.progress": "In progress",
  "task_center.status.done": "Done",
  "task_center.status.failed": "Blocked",
  "task_center.status.archived": "Archived",
  "task_center.last_sync_never": "Not synced yet",
  "task_center.execution_title": "Execution plan",
  "task_center.task_line": "Task {index}: {title}",
  "task_center.execute": "Execute",
  "task_center.mark_complete": "Mark complete",
  "task_center.executing": "Executing...",
  "task_center.no_description": "No description",
  "task_center.progress_label": "Progress: {done} / {total}",
  "task_center.all_tasks_completed": "✓ All tasks completed",
  "task_center.sync_hint": "Sync your TFS work items and drive them through OpenWork automations.",
  "task_center.syncing": "Syncing",
  "task_center.refresh": "Refresh",
  "task_center.last_sync": "Last sync: {time}",
  ...
  "workspace.badge.sandbox": "Sandbox",
  "workspace.badge.remote": "Remote",
  "workspace.badge.repo": "Repo",
  "workspace.status.needs_attention": "Needs attention",
  "workspace.status.switch": "Switch",
  "workspace.status.active": "Active",
  "workspace.action.expand": "Expand",
  "workspace.action.collapse": "Collapse",
  ...
  "session.touched_files_title": "Touched files",
  "session.touched_files_empty": "None yet.",
  "session.touched_files_open": "Open {path}",
  "session.touched_files_show_fewer": "Show fewer",
  "session.touched_files_show_more": "Show {count} more",
  "markdown_editor.default_title": "Markdown",
  "markdown_editor.readonly_formatting_hint": "Read-only preview. Editing is available for markdown, JSON, YAML, TOML, JavaScript, and TypeScript files.",
  "markdown_editor.readonly_connect_hint": "Read-only preview. Connect to an OpenWork server workspace to edit.",
  "markdown_editor.readonly_preview": "Read-only preview.",
  "markdown_editor.preview_requires_desktop_or_server": "File preview requires the desktop app or an OpenWork server workspace.",
  "markdown_editor.load_failed": "Failed to load file",
  "markdown_editor.toast_readonly": "Read-only preview",
  "markdown_editor.toast_formatting_only_scripts": "Formatting is available for JavaScript and TypeScript files only.",
  "markdown_editor.toast_already_formatted": "Already formatted.",
  "markdown_editor.toast_basic_formatting": "Applied basic formatting (whitespace only).",
  "markdown_editor.badge_unsaved": "Unsaved",
  "markdown_editor.badge_readonly": "Read-only",
  "markdown_editor.view_write": "Write",
  "markdown_editor.view_preview": "Preview",
  "markdown_editor.reload_title": "Reload from disk",
  "markdown_editor.reload": "Reload",
  "markdown_editor.format_title": "Basic whitespace formatting",
  "markdown_editor.format": "Format",
  "markdown_editor.save_title": "Save (Ctrl/Cmd+S)",
  "markdown_editor.save": "Save",
  "markdown_editor.saving": "Saving...",
  "markdown_editor.overwrite_confirm": "File changed since load. Overwrite anyway?",
  "markdown_editor.cancel": "Cancel",
  "markdown_editor.overwrite": "Overwrite",
  "markdown_editor.discard_reload_confirm": "Discard unsaved changes and reload from disk?",
  "markdown_editor.discard_close_confirm": "Discard unsaved changes and close?",
  "markdown_editor.keep": "Keep",
  "markdown_editor.discard": "Discard",
  "markdown_editor.switch_to": "Switch to {path}",
  "markdown_editor.discard_switch": "Discard & switch",
  "markdown_editor.save_switch": "Save & switch",
  "markdown_editor.empty_preview": "Nothing to preview yet. Start typing markdown in Write mode.",
  "share_workspace.title": "Share workspace",
  "share_workspace.close": "Close",
  "share_workspace.access_title": "Access",
  "share_workspace.access_hint": "Share with trusted people only. Anyone with these details can connect.",
  "share_workspace.hide": "Hide",
  "share_workspace.show": "Show",
  "share_workspace.copied": "Copied",
  "share_workspace.copy": "Copy",
  "share_workspace.config_title": "Config bundle",
  "share_workspace.config_hint": "Export `.opencode/` and `opencode.json` for reuse.",
  "share_workspace.export_desktop_only": "Export is available for local workspaces in the desktop app.",
  "share_workspace.export": "Export",
  "share_workspace.bots_title": "Bots",
  "share_workspace.bots_hint": "Alpha. Configure messaging surfaces in Settings.",
  "share_workspace.alpha": "alpha",
  "share_workspace.open_bots_settings": "Open bot settings",
  "plugins.title": "OpenCode plugins",
  "plugins.subtitle": "Manage `opencode.json` for your project or global OpenCode plugins.",
  ...
  "plugins.suggested_title": "Suggested plugins",
  "plugins.setup_show": "Setup",
  "plugins.setup_hide": "Hide setup",
  "plugins.added": "Added",
  "plugins.add": "Add",
  "plugins.step_open": "Open",
  "plugins.step_path": "Path",
  "plugins.empty": "No plugins configured yet.",
  "plugins.enabled": "Enabled",
  "plugins.add_label": "Add plugin",
  "plugins.add_placeholder": "opencode-wakatime",
  "plugins.add_hint": "Add npm package names, e.g. opencode-wakatime",
  "config.status.connected": "Connected",
  "config.status.limited": "Limited",
  "config.status.disconnected": "Not connected",
  "config.reload.connect_required": "Connect to this workspace to reload.",
  "config.reload.local_only": "Reloading is only available for local workspaces or connected OpenWork servers.",
  "config.reload.loading": "Reloading...",
  "config.reload.action": "Reload engine",
  "config.workspace.title": "Workspace config",
  "config.workspace.description": "These settings affect the active workspace (sharing, reload, bots). Global app behavior lives in Settings.",
  "config.workspace.label": "Workspace: {id}",
  "config.reload.title": "Engine reload",
  "config.reload.subtitle": "Restart the OpenCode server for this workspace.",
  "config.reload.now": "Reload now",
  "config.reload.now_hint": "Applies config updates and reconnects your session.",
  "config.reload.active_runs_warning": "Reloading will stop active tasks.",
  "config.auto_reload.title": "Auto reload (local)",
  "config.auto_reload.subtitle": "Reload automatically after agents/skills/commands/config change (only when idle).",
  "config.auto_reload.desktop_only": "Available for local workspaces in the desktop app.",
  "config.toggle.on": "On",
  "config.toggle.off": "Off",
  "config.auto_reload_resume.title": "Resume sessions after auto reload",
  "config.auto_reload_resume.subtitle": "If a reload was queued while tasks were running, send a resume message afterward.",
  "config.auto_reload_resume.disabled_hint": "Enable auto reload first",
  "config.diagnostics.title": "Diagnostics bundle",
  "config.diagnostics.subtitle": "Copy sanitized runtime state for debugging.",
  "config.copy.copied": "Copied",
  "config.copy.copy": "Copy",
  "config.sharing.title": "OpenWork server sharing",
  "config.sharing.subtitle": "Share these details with a trusted device. Keep the server on the same network for the fastest setup.",
  "config.host.offline": "Offline",
  "config.host.available": "Available",
  "config.sharing.server_url": "OpenWork Server URL",
  "config.sharing.starting_server": "Starting server…",
  "config.sharing.mdns_hint": ".local names are easier to remember but may not resolve on all networks.",
  "config.sharing.lan_hint": "Use your local IP on the same Wi-Fi for the fastest connection.",
  "config.sharing.access_token": "Access token",
  "config.sharing.access_token_hint": "Use on phones or laptops connecting to this server.",
  "config.sharing.server_token": "Server token",
  "config.sharing.server_token_hint": "Keep private. Required for approval actions.",
  "config.token.show": "Show",
  "config.token.hide": "Hide",
  "config.token.masked": "••••••••••••",
  "config.token.missing": "—",
  "config.sharing.share_hint": "For per-workspace sharing links, use {share} in the workspace menu.",
  "config.share_action": "Share...",
  "config.server.title": "OpenWork server",
  "config.server.subtitle": "Connect to an OpenWork server. Use the URL and access token from your server admin.",
  "config.server.url_label": "OpenWork server URL",
  "config.server.url_placeholder": "http://127.0.0.1:8787",
  "config.server.url_hint": "Use the URL shared by your OpenWork server.",
  "config.server.token_label": "Access token",
  "config.server.token_placeholder": "Paste your token",
  "config.server.token_hint": "Optional. Paste the access token to authenticate.",
  "config.server.resolved_url": "Resolved workspace URL: {url}",
  "config.server.not_set": "Not set",
  "config.server.workspace_id": "Workspace ID: {id}",
  "config.server.unavailable": "Unavailable",
  "config.server.test_success": "Connection successful.",
  "config.server.test_failed_hint": "Connection failed. Check the host URL and token.",
  "config.server.test_failed": "Connection failed.",
  "config.server.testing": "Testing...",
  "config.server.test": "Test connection",
  "config.save": "Save",
  "config.reset": "Reset",
  "config.server.testing_status": "Testing connection...",
  "config.server.status_updated": "Connection status updated.",
  "config.server.sync_required": "OpenWork server connection needed to sync skills, plugins, and commands.",
  "config.messaging.title": "Messaging identities",
  "config.messaging.subtitle": "Manage Telegram/Slack/WeCom identities and routing in the {identities} tab.",
  "config.messaging.identities_tab": "Identities",
  "config.desktop_only_note": "Some config features (local server sharing + messaging bridge) require the desktop app.",
  ...
  "app.error.choose_folder_or_repo": "Choose a folder or provide a Git repository URL.",
