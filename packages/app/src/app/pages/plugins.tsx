      ...
      <div class="bg-gray-2/30 border border-gray-6/50 rounded-2xl p-5 space-y-4">
        <div class="flex items-start justify-between gap-4">
          <div class="space-y-1">
            ...
            <div class="text-xs text-gray-10">{translate("plugins.subtitle")}</div>
          </div>
          <div class="flex items-center gap-2">
            ...
            >
              {translate("plugins.scope.project")}
            </button>
            <button
            ...
            >
              {translate("plugins.scope.global")}
            </button>
        ...
        <div class="flex flex-col gap-1 text-xs text-gray-10">
          <div>{translate("plugins.config_label")}</div>
          <div class="text-gray-7 font-mono truncate">
            {props.pluginConfigPath ?? translate("plugins.config_not_loaded")}
          </div>
        ...
        <div class="space-y-3">
          <div class="text-xs font-medium text-gray-11 uppercase tracking-wider">
            {translate("plugins.suggested_title")}
          </div>
                    ...
                    <div class="flex items-start justify-between gap-4">
                      ...
                      <div class="flex items-center gap-2">
                        <Show when={isGuided()}>
                          ...
                          >
                            {isGuideOpen()
                              ? translate("plugins.setup_hide")
                              : translate("plugins.setup_show")}
                          </Button>
                        </Show>
                        <Button
                            ...
                            <div class="space-y-1">
                              ...
                              <Show when={step.url}>
                                <div class="text-xs text-gray-10">
                                  {translate("plugins.step_open")}: <span class="font-mono text-gray-11">{step.url}</span>
                                </div>
                              </Show>
                              <Show when={step.path}>
                                <div class="text-xs text-gray-10">
                                  {translate("plugins.step_path")}: <span class="font-mono text-gray-11">{step.path}</span>
                                </div>
                              </Show>
                            </div>
                          )}
          ...
          <div class="flex flex-col md:flex-row gap-3">
            <div class="flex-1">
              <TextInput
                ...
                placeholder={translate("plugins.add_placeholder")}
